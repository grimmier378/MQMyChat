...
void MyChatDatabase::SeedDefaultChannels(int presetId)
{
    ...
    run(fmt::format("INSERT INTO channels (preset_id, channel_id, name, enabled, echo, main_enable, enable_links, pop_out, locked, scale, main_font_size, tab_order) VALUES ({}, 0, 'Consider', 1, '/dgt', 1, 0, 0, 0, 1.0, 16, 2)", presetId));
    ...
    run(fmt::format("INSERT INTO channels (preset_id, channel_id, name, enabled, echo, main_enable, enable_links, pop_out, locked, scale, main_font_size, tab_order) VALUES ({}, 2, 'Combat', 1, '/dex ', 0, 0, 0, 0, 1.3350000381469727, 16, 3)", presetId));
    ...
    run(fmt::format("INSERT INTO channels (preset_id, channel_id, name, enabled, echo, main_enable, enable_links, pop_out, locked, scale, main_font_size, tab_order) VALUES ({}, 3, 'Crits', 1, '/dgae /lootutils', 0, 0, 0, 0, 1.3359999656677244, 16, 4)", presetId));
    ...
    run(fmt::format("INSERT INTO channels (preset_id, channel_id, name, enabled, echo, main_enable, enable_links, pop_out, locked, scale, main_font_size, tab_order) VALUES ({}, 4, 'Exp AA pts', 1, '/say', 1, 0, 0, 0, 1.28600001335144, 16, 12)", presetId));
    ...
    run(fmt::format("INSERT INTO channels (preset_id, channel_id, name, enabled, echo, main_enable, enable_links, pop_out, locked, scale, main_font_size, tab_order) VALUES ({}, 6, 'Guild', 0, '/say', 1, 0, 0, 0, 1.0, 16, 11)", presetId));
    ...
    run(fmt::format("INSERT INTO channels (preset_id, channel_id, name, enabled, echo, main_enable, enable_links, pop_out, locked, scale, main_font_size, tab_order) VALUES ({}, 11, 'OOC', 1, '/ooc', 1, 1, 0, 0, 1.4459999799728394, 16, 7)", presetId));
    ...
    run(fmt::format("INSERT INTO channels (preset_id, channel_id, name, enabled, echo, main_enable, enable_links, pop_out, locked, scale, main_font_size, tab_order) VALUES ({}, 12, 'Raid', 0, '/rsay', 1, 0, 0, 0, 1.4529999494552608, 16, 12)", presetId));
    ...
    run(fmt::format("INSERT INTO channels (preset_id, channel_id, name, enabled, echo, main_enable, enable_links, pop_out, locked, scale, main_font_size, tab_order) VALUES ({}, 15, 'Tells', 1, '/tell', 1, 1, 0, 0, 1.3830000162124634, 16, 9)", presetId));
